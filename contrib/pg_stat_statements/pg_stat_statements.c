...
pg_stat_statements(PG_FUNCTION_ARGS)
{
	...
	TupleDescInitEntry(tupdesc, (AttrNumber) 6, "rows",
					   INT8OID, -1, 0);
	TupleDescInitEntry(tupdesc, (AttrNumber) 7, "shared_blks_hit",
					   INT8OID, -1, 0);
	TupleDescInitEntry(tupdesc, (AttrNumber) 8, "shared_blks_read",
					   INT8OID, -1, 0);
	TupleDescInitEntry(tupdesc, (AttrNumber) 9, "shared_blks_written",
					   INT8OID, -1, 0);
	TupleDescInitEntry(tupdesc, (AttrNumber) 10, "local_blks_hit",
					   INT8OID, -1, 0);
	TupleDescInitEntry(tupdesc, (AttrNumber) 11, "local_blks_read",
					   INT8OID, -1, 0);
	TupleDescInitEntry(tupdesc, (AttrNumber) 12, "local_blks_written",
					   INT8OID, -1, 0);
	TupleDescInitEntry(tupdesc, (AttrNumber) 13, "temp_blks_read",
					   INT8OID, -1, 0);
	TupleDescInitEntry(tupdesc, (AttrNumber) 14, "temp_blks_written",
					   INT8OID, -1, 0);
